...
describe User do
  ...
  it { should have_many :one_on_ones}
  ...
  it "returns a list of one on ones from the teacher role" do
  	@david.one_on_ones_as_teacher.should =~ [@one_on_one_2, @one_on_one_3]
  	@teddy.one_on_ones_as_teacher.should == [@one_on_one_1]
  end

  it "returns a list of one_on_ones from the student role for a student" do
  	@amal.one_on_ones_as_student.should =~ [@one_on_one_1, @one_on_one_3]
  end

  it "returns a list of one_on_ones from the student role for a student-turned-teacher" do
    @teddy.one_on_ones_as_student.should == [@one_on_one_2]
  end
